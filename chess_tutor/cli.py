"""Command-line interface for the Adaptive Chess Tutor."""
# Dual import strategy
try:
    from .tutor_core import ChessTutor, build_index  # package context
...
# New dynamic command registry (updated)
COMMANDS = [
...
def main():
    ...
    current_ply = 0
    last_listed_games = []  # keeps last shown list for numeric selection
    print_help()
    while True:
        q = input("You: ").strip()
