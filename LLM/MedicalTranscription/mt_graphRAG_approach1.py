...
async def build_graph(llm) -> PipelineResult:
...
if __name__ == "__main__":
    ...
    TEXT_TEMPLATE = ("Medical transcription for {candidate} is given below."
    ...
    TEXT = TEXT_TEMPLATE.format(candidate=candidate)
    ...
    try:
        ...
        if rebuild:
            ...
            res = asyncio.run(build_graph(llm))
            print(res)
